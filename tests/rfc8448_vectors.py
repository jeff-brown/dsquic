...
# RFC 8448 §4: the ClientHello bytes the binder covers, which is the
# complete message minus its binders. Its length field still counts
# them, so this is a truncation rather than a shorter encoding.
CLIENT_HELLO_BINDER_PREFIX = bytes.fromhex(  # 477 octets
