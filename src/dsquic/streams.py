...
class RecvStream:
    ...
    def on_stream_frame(self, frame: Stream) -> None:
        ...
        # §3.2: Recv -> Size Known on FIN; -> Data Recvd when all bytes
        # are in. Figure 3's states only advance, so Data Read is
        # terminal and a retransmitted frame does not reopen it.
